...
if (arreglo_1[1] <= arreglo_2[1] && arreglo_1[length(arreglo_1)] >= arreglo_2[length(arreglo_2)])
    println("$(A)$(N1),$(N2)$(B) Contains $(A1)$(N3),$(N4)$(B1)")
else
    println("$(A)$(N1),$(N2)$(B) Doesn't Contains $(A1)$(N3),$(N4)$(B1)")
end